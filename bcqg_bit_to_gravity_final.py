...
This executable status surface follows the canonical ledger instead of the
superseded frontier flag in bcqg_quantum_hda_killer.py.  It deliberately keeps
candidate-architecture closure separate from experimental confirmation and
from a uniform simultaneous Jmax->infinity, epsilon->0 theorem.
"""
...
def run():
    ...
    core_certificate_present = gates.get("CORECERT", {}).get("status") in {"conditional", "proved", "tested_finite"}
    ...
    return {
        ...
        "chain": {
            ...
            "canonical_core_certificate": core_certificate_present,
        },
        ...
        "scope": (
            "Candidate mathematical/computational architecture closure at fixed regulator-safe "
            "Peter-Weyl cutoff. Uniform simultaneous Jmax->infinity control, microscopic uniqueness, "
            "quantum measure, matter and empirical validation remain separate research questions."
        ),
    }
